...
function bindModalEvents() {
    ...
    // --- Icon toggle clicks ---
    $modal.on('click.ass-tf', '.ass-tf-icon-secret, .ass-tf-icon-required, .ass-tf-icon-optional, .ass-tf-icon-immutable, .ass-tf-icon-extend, .ass-tf-icon-important', function (e) {
        e.stopPropagation();
        const $btn = $(this);
